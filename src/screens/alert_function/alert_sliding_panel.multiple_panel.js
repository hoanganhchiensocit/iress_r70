...
import FlashingWrapper from '~/screens/order/flashing_with_redux.js'
// Common
...
export default class AlertSlidingPanel extends XComponent {
    ...
    setHeightTriggerPinPrice = (height) => {
        setTimeout(() => {
            this.dic.refAlertPriceHeader && this.dic.refAlertPriceHeader.current && this.dic.refAlertPriceHeader.current.setHeightTriggerPinPrice(height)
        }, 300);
    }
